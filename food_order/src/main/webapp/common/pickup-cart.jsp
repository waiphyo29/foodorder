...
<div class="mb-5 d-flex justify-content-center" >
  <div><a href="menu?mode=DELI&pickup=true" class="text-info" style="text-decoration: none;"><h3>Pick Up</h3></a></div>
  <div style="display: flex;justify-content: center;">
    <a href="menu?mode=DELI&pickup=false"><h3 class="my-1 mx-3"><i class="bi bi-toggle2-off text-info"></i></h3></a>
  </div>
  <div><a href="menu?mode=DELI&pickup=false" class="text-dark" style="text-decoration: none;"><h3>Delivery</h3></a></div>
</div>
